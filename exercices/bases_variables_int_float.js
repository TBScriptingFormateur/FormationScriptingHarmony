...
function variable_int_operators_3(){
    ...
    var point_de_vie_finaux = points_de_vie_de_base + degats_cone_de_glace + degats_boule_de_feu + potion_de_soin
    
    MessageBox.information(point_de_vie_finaux)
...
function variable_float(){
    ...
    var longueur_moyenne_barbe = (longeur_barbe_de_fili + longeur_barbe_de_balin + longeur_barbe_de_thorin + longeur_barbe_de_kili + longeur_barbe_de_bifur +longeur_barbe_de_bombur)/nombre_de_barbu
